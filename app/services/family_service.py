...
class FamilyService:
    def __init__(self):
        self.dfs = {}
        # Changer la plage pour inclure 2010
    ...
    def get_iris_families_by_commune(self, commune: str, geocode_service):
       try:
           iris_codes = geocode_service.iris_geo[geocode_service.iris_geo["DEPCOM"] == str(commune)]["CODE_IRIS"].tolist()
           data = {}
           for year in range(2017, 2022):
               try:
                   ...
                   for iris in iris_codes:
                       iris_row = iris_df[(iris_df["IRIS"] == iris) & (iris_df["COM"] == str(commune))]
